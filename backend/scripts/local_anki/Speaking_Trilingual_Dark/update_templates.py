"""更新 Speaking_Trilingual_Dark 模型的 Anki 樣板腳本。

Update the HTML/CSS templates and fields of the Speaking_Trilingual_Dark
Anki note model from local template files.
"""
...
async def update_all_templates(client: AnkiClient, backend_directory: str):
    ...
    Update templates and fields of all listed Anki note models.
    ...
    print("🔧 開始更新 Anki 現有筆記模型的 HTML/CSS 樣板與欄位...")
